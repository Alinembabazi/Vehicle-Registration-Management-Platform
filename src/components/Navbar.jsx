...
return (
  <nav className="bg-blue-950 text-white px-6 py-4 flex justify-between items-center shadow-lg sticky top-0 z-50">
    <Link to="/" className="text-xl font-bold flex items-center gap-2 hover:scale-105 transition-transform">Vehicle Management System</Link>
      ...
      {isAuthenticated ? (
        <>
          ...
          <button
            ...
            className="bg-white text-blue-950 px-4 py-1.5 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
          >
            Logout
          </button>
        </>

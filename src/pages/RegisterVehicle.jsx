...
const INITIAL_STATE = {
  manufacture: "", model: "", year: "", vehicleType: "SUV", bodyType: "Sedan", color: "", fuelType: "PETROL", engineCapacity: "", seatingCapacity: "",
  odometerReading: "", vehiclePurpose: "PERSONAL", vehicleStatus: "USED", state: "Kigali", plateNumber: "", plateType: "PRIVATE",
  ownerName: "", ownerType: "INDIVIDUAL", nationalId: "", passportNumber: "", companyRegNumber: "", address: "", mobile: "", email: "",
  registrationStatus: "ACTIVE", registrationDate: "", expiryDate: "", policyNumber: "", companyName: "", insuranceType: "Comprehensive", insuranceStatus: "ACTIVE", insuranceExpiryDate: "",
  roadworthyCert: "", customsRef: "", proofOfOwnership: ""
};
...
export default function RegisterVehicle() {
  ...
  const { mutate, isPending } = useMutation({
    ...
    onSuccess: () => { queryClient.invalidateQueries(["vehicles"]); toast.success("Vehicle registered!"); navigate("/dashboard"); },
      ...
      <div className="bg-white p-6 shadow-md rounded-xl">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between mt-4">
            <button type="button" onClick={prev} disabled={step === 0} className="px-4 py-2 bg-gray-300 rounded">Previous</button>
            <button type="submit" disabled={isPending} className="px-4 py-2 bg-blue-600 text-white rounded">
              {step === STEPS.length - 1 ? (isPending ? "Submitting..." : "Submit") : "Next"}
            </button>
          </div>
        </form>
      </div>
